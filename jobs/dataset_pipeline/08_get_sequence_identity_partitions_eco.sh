#!/bin/bash
#
#SBATCH --job-name=08_get_seq_ident_partitions_eco                     # Job name
#SBATCH --output=logs/08_get_seq_ident_partitions_eco.%j.out           # Standard output (%j expands to jobId)
#SBATCH --error=logs/08_get_seq_ident_partitions_eco.%j.err            # Standard error
...
/nfs/home/students/a.spannagl/.local/kahip64/bin/kaffpa \
  ...
  --imbalance=3 \
  --output_filename=/nfs/scratch/pdb_dimers/KaHIP/seq_ident_partitions_eco_output.txt