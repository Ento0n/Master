#!/bin/bash
#
#SBATCH --job-name=get_seq_ident_partitions_strong                     # Job name
#SBATCH --output=logs/get_seq_ident_partitions_strong.%j.out           # Standard output (%j expands to jobId)
#SBATCH --error=logs/get_seq_ident_partitions_strong.%j.err            # Standard error
