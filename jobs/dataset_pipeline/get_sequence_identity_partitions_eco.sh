#!/bin/bash
#
#SBATCH --job-name=get_seq_ident_partitions_eco                     # Job name
#SBATCH --output=logs/get_seq_ident_partitions_eco.%j.out           # Standard output (%j expands to jobId)
#SBATCH --error=logs/get_seq_ident_partitions_eco.%j.err            # Standard error
