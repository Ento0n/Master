#!/bin/bash
#
#SBATCH --job-name=extract_sequences                # Job name
#SBATCH --output=logs/extract_sequences.%j.out      # Standard output (%j expands to jobId)
#SBATCH --error=logs/extract_sequences.%j.err       # Standard error
