...
python /nfs/home/students/a.spannagl/master_repository/scripts/data_pipeline/13_sample_negatives.py --output /nfs/scratch/pdb_dimers/final_datasets/balanced_interactions_keep_homomers.tsv --keep-positive-homomers