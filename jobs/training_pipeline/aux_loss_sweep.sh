#!/bin/bash
#
#SBATCH --job-name=aux-loss-sweep                                # Job name
#SBATCH --array=0-7%4
#SBATCH --output=logs/aux-loss-sweep-%A_%a.out                   # Standard output (%j expands to jobId)
#SBATCH --error=logs/aux-loss-sweep-%A_%a.err                    # Standard error
