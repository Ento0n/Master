#!/bin/bash
#
#SBATCH --job-name=balanced-bce-sweep                                # Job name
#SBATCH --array=0-27%4
#SBATCH --output=logs/balanced-bce-sweep-%A_%a.out                   # Standard output (%j expands to jobId)
#SBATCH --error=logs/balanced-bce-sweep-%A_%a.err                    # Standard error
