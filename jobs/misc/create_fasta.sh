#!/bin/bash
#
#SBATCH --job-name=create_fasta                     # Job name
#SBATCH --output=logs/create_fasta.%j.out           # Standard output (%j expands to jobId)
#SBATCH --error=logs/create_fasta.%j.err            # Standard error
